...
import com.example.pablo.project_contentprovider.Adaptadores.AdaptadorInterprete;
...
public class Tab3 extends Fragment {
    ...
    private AdaptadorInterprete ad;
    private ListView lv;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        List lista=cr.sacaInterpreteList();
        ad=new AdaptadorInterprete(getActivity(),R.layout.item_list,lista);
        lv.setAdapter(ad);
        return v;
    }
